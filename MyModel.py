...
class DeepFM(torch.nn.Module):
    ...
    def __init__(self,field_size, feature_sizes, embedding_size = 4, is_shallow_dropout = True, dropout_shallow = [0.5,0.5],
                 ...
                 use_fm = True, use_ffm = False, use_deep = True, use_dense = False, dense_size = 200,loss_type = 'logloss', eval_metric = roc_auc_score,
        ...
        if self.use_deep:
            ...
            if self.use_dense:
                self.linear_1 = nn.Linear(self.field_size*self.embedding_size+self.dense_size,deep_layers[0])
            else:
    ...
    def forward(self, Xi, Xv):
        ...
        """
        if self.use_dense:
            Xd = Xv[:,self.field_size:]
            Xv = Xv[:,:self.field_size]
        ...
        if self.use_deep:
            ...
            if self.use_dense:
                deep_emb = torch.cat([deep_emb,Xd],1)
...
xv_i = np.array([[ 1.00000000e+00,  1.00000000e+00,  1.00000000e+00,
         1.00000000e+00,  1.00000000e+00,  1.00000000e+00,
         1.00000000e+00,  1.00000000e+00,  6.09887064e-01,
        -3.17003161e-01, -1.83307350e-01, -4.45917211e-02,
        -4.00365591e-02,  2.60544335e-03, -2.43274420e-02,
        -1.35902567e-02, -2.06686687e-02, -2.39776302e-04,
        -8.98106117e-03, -1.32717369e-02, -9.00286250e-03,
        -9.20017343e-03, -1.12582045e-02, -9.56592243e-03,
        -5.72999334e-03, -3.99997272e-03, -9.94744524e-03,
        -6.57328777e-03, -4.06617252e-03, -7.16522615e-03,
        -3.39697767e-03, -5.05888509e-03, -6.38805423e-03,
        -6.68853614e-03, -6.55218540e-03, -3.32565443e-03,
        -7.25812372e-03, -9.18245874e-04,  1.18093006e-03,
         3.55028023e-04, -4.88233333e-03, -1.80893322e-03,
        -3.13342735e-03, -3.14912642e-03, -4.47223382e-03,
         8.49320320e-04, -3.30703938e-03, -3.95207189e-06,
        -3.04178707e-03, -3.35240504e-03, -2.29544588e-03,
        -2.08881940e-03, -1.75165117e-03, -2.58994359e-03,
         5.19961119e-04, -3.13837733e-03, -3.30228242e-03,
         3.50067829e-04]], dtype='float32')

print(aa.predict([xi_i, xv_i]))
